...
<label class="description" for="bartleby_options[bartleby_logo]"><?php esc_attr_e( 'Leave blank to use the site title', 'bartleby' ); ?></label>
	...
	<tr valign="top"><th scope="row"><label for="bartleby_options[home_header_image]">Custom Homepage Header Image</label></th>
	<td>
	<input id="bartleby_options[home_header_image]" name="bartleby_options[home_header_image]" type="url" size="60" value="<?php esc_attr_e($options['home_header_image']); ?>" />
<label class="description" for="bartleby_options[home_header_image]"></label>
	</td>
	</tr>

	<tr valign="top"><th scope="row"><label for="bartleby_options[home_subtext]">Custom Homepage Subtext</label></th>
	<td>
	<input id="bartleby_options[home_subtext]" name="bartleby_options[home_subtext]" type="url" size="60" value="<?php esc_attr_e($options['home_subtext']); ?>" />
<label class="description" for="bartleby_options[home_subtext]"></label>
	</td>
	</tr>
...
function bartleby_validate_options( $input ) {
	...
	$input['home_header_image'] = esc_url( $input['home_header_image'] );
